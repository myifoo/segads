    ...
    public ForecasterWrapper model(String type) {
        ...
        try {
            if (StringUtils.isNotEmpty(type)) {
                ...
                Class<?> tsModelClass = Class.forName("com.myitech.segads.models.forecast." + type);
    ...
    public JSONObject toJSONObject() {
        try {
            ...
            JSONObject result = new JSONObject().put(ForecastConstants.TYPE, type)
                    .put(ForecastConstants.SOURCE_SERIES, DataSetUtils.toJSONArray(source))
                    .put(ForecastConstants.TARGET_SERIES, DataSetUtils.toJSONArray(target));
